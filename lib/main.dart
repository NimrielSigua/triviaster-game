...
class _EnterGamePageState extends State<EnterGamePage> {
 ...
 void showMessageBox(
    ...
    builder: (context) {
      return AlertDialog(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(15), // Rounded corners for modern feel
        ),
        title: Row(
          children: [
            Icon(
          ...
          children: [
            ...
            if (role != null)
              Text(
                'Role: $role',
                style: TextStyle(
                  color: Colors.purpleAccent, // Different neon color for variety
                  fontSize: 14,
                  fontWeight: FontWeight.bold,
                ),
              ),
  ...
  style: TextStyle(
    ...
    fontWeight: FontWeight.bold, // Makes the input text bold
  ),
  decoration: InputDecoration(
    ...
    filled: true,
    fillColor: Colors.black45, // Adds a background color to the input field
    ...
    enabledBorder: OutlineInputBorder(
      borderRadius: BorderRadius.circular(15), // Rounded corners when not focused
      borderSide: BorderSide(
        color: Colors.white, // Border color when not focused
        width: 1.5,
      ),
    ),
    contentPadding: EdgeInsets.symmetric(vertical: 15, horizontal: 20), // Adds padding inside the field
  ),
),
      ...
      child: Container(
        ...
        child: ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            ...
            textStyle: TextStyle(
              fontSize: 18, // Larger font size for a bold look
              fontWeight: FontWeight.bold,
            ),
            shape: RoundedRectangleBorder(
